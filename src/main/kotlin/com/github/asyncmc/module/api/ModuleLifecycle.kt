 ...
 * @since 2021-03-16
 */
public enum class ModuleLifecycle {
    CONSTRUCTION,
    PRE_INIT,
    INIT,
    POST_INIT,
    ...
    public val previous: ModuleLifecycle? get() = values.getOrNull(ordinal - 1)
    public val next: ModuleLifecycle? get() = values.getOrNull(ordinal + 1)
}
